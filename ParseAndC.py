...
##
##
## Below is the sole input structure that I tested my program with (WAIT! You mean that is NOT adequate testing?):
##
...
INCLUDE_FILE_PATHS = r"C:\Users\PKMANNA\OneDrive - Intel Corporation\Documents\Shared\INCLUDE_FILE_DIR"
...
def printHelp():
	...
	OUTPUT("-p, --pad                 to indicate that the compiler padding will be ON")
